      ...
      <section className="mx-auto flex max-w-5xl flex-col gap-5">
        ...
        <section className="rounded-[2.25rem] border border-[#dbe7df] bg-white p-6 shadow-sm sm:p-8">
          ...
          <p className="mt-3 max-w-2xl text-base font-semibold leading-7 text-[#5f6f67]">
            Browse local jobs. Worker login is required before contacting posters.
          </p>

          <form className="mt-6 grid gap-3 sm:grid-cols-[1fr_180px_auto]" action="/jobs">
            <input
              name="zip"
              defaultValue={zip}
              inputMode="numeric"
        ...
        {zip.length !== 5 ? (
          <section className="rounded-[2rem] border border-[#dbe7df] bg-white p-6 text-center shadow-sm">
            <h2 className="text-2xl font-black">Enter a ZIP code to browse jobs.</h2>
            <p className="mt-2 text-base font-semibold text-[#5f6f67]">
              Local listings will appear here.
            </p>
          </section>
        ) : null}
        ...
        {zip.length === 5 && jobs.length === 0 ? (
          <section className="rounded-[2rem] border border-[#dbe7df] bg-white p-6 text-center shadow-sm">
            <h2 className="text-2xl font-black">No live jobs in {zip} yet.</h2>
            <p className="mt-2 text-base font-semibold text-[#5f6f67]">
              Check nearby ZIPs or come back after more posts go live.
            </p>
          </section>
        ) : null}
